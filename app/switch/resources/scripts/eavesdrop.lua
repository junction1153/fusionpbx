...
--eavesdrop
        if (session:ready()) then
                ...
                while true do
                        ...
                        if(uuid) then
                                freeswitch.consoleLog("NOTICE", "[eavesdrop] uuid1 "..uuid);
                                ...
                                freeswitch.consoleLog("NOTICE", "[eavesdrop] uuid2 "..uuid)
                        else
                                session:execute("playback","silence_stream://5000")
                                freeswitch.consoleLog("NOTICE", "[eavesdrop] else condition ");
                        end
