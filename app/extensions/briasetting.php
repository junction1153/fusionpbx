...
//includes
	if(isset($_POST) && count($_POST) > 0){
		...
		if($bria_setting_rows == 0){
			$sql = "insert into bria_setting(bria_group,domain_uuid) VALUES('".$_POST['bria_group']."','".$_POST['domain_uuid']."')";
		}else{
			$sql = "update bria_setting set bria_group= '".$_POST['bria_group']."' where domain_uuid ='".$_POST['domain_uuid']."' ";
